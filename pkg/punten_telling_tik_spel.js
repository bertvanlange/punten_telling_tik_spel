 ...
 * @returns {string}
 */
export function get_tikkers_url() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_tikkers_url();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function get_getikt_url() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_getikt_url();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('punten_telling_tik_spel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
